...
class AutoregressiveDecoder(ModelPart):
    ...
    @tensor
    def runtime_att_weights(self):
        return self.runtime_loop_result[4]
    ...
    def decoding_loop(self, train_mode: bool, sample: bool = False,
        ...
        first_attn_weights = final_loop_state.histories.attention_histories[0].weights

        # TODO mask should include also the end symbol
        mask = final_loop_state.histories.mask

        return logits, decoder_outputs, mask, decoded, first_attn_weights
